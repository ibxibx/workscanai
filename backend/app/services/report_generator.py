    ...
    def generate_pdf_report(analysis_data: Dict, output_path: str):
        ...
        hero = Table([[
            ...
            Table([[Paragraph('<b>Tasks Analyzed</b>', ST['label']),''],
                   [Paragraph(str(len(results)), style('tc', fontSize=22, fontName='Helvetica-Bold', textColor=GRAY_900, spaceAfter=4)),''],
                   [Paragraph('workflow tasks', style('tl', fontSize=10, textColor=GRAY_600, fontName='Helvetica', spaceBefore=4)),'']],
