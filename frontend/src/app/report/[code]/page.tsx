    ...
    <div className="min-h-screen bg-white text-[#1d1d1f]">
      ...
      <div className="bg-[#0071e3] text-white px-4 py-[10px]">
        <div className="max-w-[980px] mx-auto flex items-center justify-between gap-[8px] min-w-0">
          ...
          <span className="text-[12px] opacity-80 hidden sm:inline truncate">{t('bannerTagline')}</span>
      ...
      <div className="max-w-[980px] mx-auto px-4 sm:px-6 pt-[32px] sm:pt-[48px] pb-[60px] sm:pb-[80px]">
        ...
        <div className="mt-[40px] sm:mt-[48px] text-center text-[13px] text-[#86868b]">
          <p>{t('genBy')} <a href="https://workscanai.vercel.app" className="text-[#0071e3] hover:underline">WorkScanAI</a> &mdash; {t('reportWord')} <span className="font-mono">#{code}</span></p>
          <p className="mt-[12px] text-[11px] leading-[1.5] max-w-[560px] mx-auto">
            {t('disclaimer')}
          </p>
        </div>
      </div>
