  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-[#e5e5ea]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between gap-2 min-w-0">
        {/* Logo */}
        <Link href="/" className="flex items-center gap-[6px] text-[16px] sm:text-[18px] font-semibold tracking-tight text-[#1d1d1f] shrink-0 min-w-0">
          <Brain className="h-[16px] w-[16px] sm:h-[18px] sm:w-[18px] shrink-0" />
          <span className="truncate">WorkScanAI</span>
        </Link>
          ...
          {isLoaded && (
            email ? (
              <div className="flex items-center gap-2 md:gap-3">
                <div className="hidden md:flex items-center gap-1.5 text-[13px] text-[#6e6e73]">
